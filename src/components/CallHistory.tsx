  ...
  return (
    <Card className={className}>
      <CardHeader className="pb-2 flex flex-row items-center justify-between">
        <CardTitle className="text-lg font-semibold text-neonBlue">Chamadas Bloqueadas</CardTitle>
        <Button 
          variant="outline" 
          size="sm" 
      ...
      <CardContent>
        {calls.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <p className="text-neonBlue">Nenhuma chamada foi bloqueada ainda</p>
          ...
          <ScrollArea className="h-[280px] pr-4">
            <div className="space-y-3">
              {calls.map((call) => (
                <div key={call.id} className="bg-darkNeon-700 rounded-lg p-3 border border-neonBlue/20">
